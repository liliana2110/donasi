...
<head>
    ...
    <title>darikita.com - User Profile</title>
            ...
            <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                ...
                <?php
                    if (isset($_SESSION['status_login'])) {
                        echo '<a href="../script/logout.php">
                    <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">KELUAR</button></a>';
                    } else {
                        echo '<button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">MASUK</button>';
                    }
        ...
        <div class="md:w-2/6 w-full flex flex-col justify-center border rounded-lg mx-auto p-4 shadow-xl bg-[#F8F8F8]">
            ...
            <form class="w-full rounded-sm px-2 py-6">
                ...
                <div class="lg:w-full flex mt-10 mb-4">
                    <a href="./ubah-user-profil.php" class="w-full">
                        <button type="button" id="change-profile" class="bg-white hover:bg-blue-800 hover:text-white w-full  border border-blue-500 text-warna_aksen font-bold py-2 rounded">UBAH PROFIL</button>
                    </a>
                </div>
