            ...
            <div class="flex p-2">
                ...
                <div class="items-start hidden w-full md:flex md:w-auto md:order-1" id="navbar-cta">
                    <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 rounded-lg bg-[#F8F9FB] md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0">
                        ...
                        <li>
                            <a href="./donasi.php" class="block py-2 px-3 md:p-0 font-bold text-blue-600">Donasi</a>
                        </li>
                    </ul>
                </div>
            </div>    
        ...
        <div class="md:w-1/2 sm:w-full flex flex-wrap justify-center border rounded-lg mx-auto p-4 shadow-xl bg-[#F8F8F8]">
            ...
            <form method="post" action="../script/insert-donasi.php" class="w-full rounded-sm px-8 py-6">
                ...
                <div class="mb-4 ">
                    ...
                    <textarea id="alamat" required name="alamat" class="shadow bg-white appearance-none border rounded w-full py-2 px-3 text-gray-700"></textarea>
                </div>
                ...
                <div id="form-container">
                    ...
                    <div class="mb-4">
                        ...
                        <select id="idCategory" required name="idCategory" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 focus:outline-blue-400">
                    ...
                    <div class="mb-4">
                        ...
                        <select id="food-type" required name="food-type" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 focus:outline-blue-400">
                    ...
                    <!-- food name -->
                    <div class="mb-4">
                        <label for="food" class="block text-gray-700 required text-sm font-bold mb-2">Nama Makanan</label>
                ...
                <div class="lg:w-full flex  mb-4">
                    <a href="donasi.php" class="w-full mx-auto">
                        <button type="button" class="
                        bg-white border-2 border-warna_primary hover:bg-gray-100 w-full  text-warna_aksen font-bold py-2 rounded">BATAL</button>
                    </a>
                </div>
                <!-- last button -->
            </form>
